...
#####Maps:
All maps are located in "Data" folder with the game and can be edited by text editor with fixed height fonts. Also there is map template with emplty map. To make map file visible for the game it shold be placed in "Data" folder and it should have number of stage in file name and have .map extension. Other files will be ignored. Example: "20.map".  
